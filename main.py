...
def call_result(n1, n2):
    ...
    consumerKey = "jWaXkDYH56eaMTIKlPWe5kHBu" //This is should be changed according to your account
    consumerSecret = "CYY47YoVzuufFWCVe54oxklesrN1A9qUzxCL8qkgJGcx7OgV6Z"  //This is should be changed according to your account
    accessToken = "886236788850905088-5Xg5vChIWwQPxTNV8DKefeBCErhdHht"  //This is should be changed according to your account
    accessTokenSecret = "PTu0bJFFoO6iphZ6tQ5RuZpj59gWzFjYnGU2anza8av3L"  //This is should be changed according to your account
